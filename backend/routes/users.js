...
const passportGoogleAuthorize = passport.authorize("googleToken", {
  session: false,
});
const passportFacebookAuthorize = passport.authorize("facebookToken", {
  session: false,
});
